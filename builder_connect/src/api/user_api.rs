...
pub async fn create_profile(db: Data<MongoRepo>, new_user: Json<User>) -> HttpResponse {
    let data = User {
        ...
        age_weight: new_user.age_weight.to_owned(),
        location: new_user.location.to_owned(),
        location_weight: new_user.location_weight.to_owned(),
        employer: new_user.employer.to_owned(),
        employer_weight: new_user.employer_weight.to_owned(),
        reason: new_user.reason.to_owned(),
        project_interests: new_user.project_interests.to_owned(),
        project_interests_weight: new_user.project_interests_weight.to_owned(),
        personality_interests: new_user.personality_interests.to_owned(),
        personality_interests_weight: new_user.personality_interests_weight.to_owned(),
        skills: new_user.skills.to_owned(),
        skills_weight: new_user.skills_weight.to_owned(),
